...
export const projects: ProjectType[] = [
  {
    ...
    stack:
      'To manage the state of the application, the redux toolkit was used as the most modern and optimal solution. React tables were used to render tables as one of the most advanced lightweight solutions. The Material UI was used as a compromise solution to get the application development started faster. Also, for processing forms, the react forms hook was used as the most modern and productive solution. To improve the user experience, a framer motion was also added to the application.',
    problems:
