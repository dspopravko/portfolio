    ...
    <section className={s.wrapper} id={'skills'}>
      ...
      <div className={s.container}>
        ...
        <div className={s.skill}>
          <div className={s.logoWrapper}>
            <img
              alt={'Storybook-logo'}
              src={
                'https://img.stackshare.io/service/4906/default_db6159e1ae3d61e909d2c05d5a2c6990bdc6088f.png'
              }
            />
          </div>
          <h3>Story book</h3>
        ...
        <div className={s.skill}>
          <div className={s.logoWrapper}>
            <img
              alt={'REST-API-logo'}
              src={
                'https://miro.medium.com/max/440/1*J3G3akaMpUOLegw0p0qthA.png'
              }
            />
          </div>
          <h3>REST API</h3>
          <p>
            Developed data access layer (DAL) for interaction with RESTful web
        ...
        <div className={s.skill}>
          ...
          <h3>TDD - JEST</h3>
          <p>
            Implemented TDD by creating Unit tests for reducers and components
            with Jest.
          </p>
        </div>
        <div className={s.skill}>
          ...
          <h3>Redux</h3>
          <p>
            Implemented Redux for state management of app as BLL. Created
            reducers for immutable state modification.
          </p>
        </div>
      </div>
    </section>
